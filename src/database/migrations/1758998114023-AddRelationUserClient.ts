...
export class AddRelationUserClient1758998114023 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "client" ADD CONSTRAINT "UQ_ad3b4bf8dd18a1d467c5c0fc13a" UNIQUE ("userId")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "client" DROP CONSTRAINT "UQ_ad3b4bf8dd18a1d467c5c0fc13a"`);
