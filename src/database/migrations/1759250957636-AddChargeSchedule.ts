...
export class AddChargeSchedule1759250957636 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "charge_schedule" ADD CONSTRAINT "FK_338ef6d9bbddabf5547e9995a82" FOREIGN KEY ("enrollmentId") REFERENCES "enrollments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "charge_schedule" DROP CONSTRAINT "FK_338ef6d9bbddabf5547e9995a82"`,
    );
    await queryRunner.query(
      `ALTER TABLE "enrollments" ALTER COLUMN "price" TYPE numeric`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."charge_schedule_recurrenceinterval_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."charge_schedule_billingmodel_enum"`,
    );
  }
}
