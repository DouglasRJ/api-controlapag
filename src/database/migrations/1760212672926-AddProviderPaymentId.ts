...
export class AddProviderPaymentId1760212672926 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "provider" ADD "providerPaymentId" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "charge" ALTER COLUMN "amount" TYPE numeric`);
        await queryRunner.query(`ALTER TABLE "charge_exception" ALTER COLUMN "newAmount" TYPE numeric`);
        await queryRunner.query(`ALTER TABLE "provider" DROP COLUMN "providerPaymentId"`);
    }
