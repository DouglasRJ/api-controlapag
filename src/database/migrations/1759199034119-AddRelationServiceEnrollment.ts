...
export class AddRelationServiceEnrollment1759199034119
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."enrollments_status_enum" AS ENUM('ACTIVE', 'INACTIVE', 'CANCELLED', 'COMPLETED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "enrollments" ADD CONSTRAINT "FK_613b4da8e0ca9298902baca8294" FOREIGN KEY ("serviceId") REFERENCES "service"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "enrollments" DROP CONSTRAINT "FK_613b4da8e0ca9298902baca8294"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service" ALTER COLUMN "defaultPrice" TYPE numeric`,
    );
