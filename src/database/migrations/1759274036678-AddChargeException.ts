...
export class AddChargeException1759274036678 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "charge_exception" ADD CONSTRAINT "FK_325649d1a883f7dfedc768998a9" FOREIGN KEY ("enrollmentId") REFERENCES "enrollments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "charge_exception" DROP CONSTRAINT "FK_325649d1a883f7dfedc768998a9"`);
        await queryRunner.query(`ALTER TABLE "enrollments" ALTER COLUMN "price" TYPE numeric`);
        await queryRunner.query(`ALTER TABLE "service" ALTER COLUMN "defaultPrice" TYPE numeric`);
        await queryRunner.query(`DROP TABLE "charge_exception"`);
        await queryRunner.query(`DROP TYPE "public"."charge_exception_action_enum"`);
    }
